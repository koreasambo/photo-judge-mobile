...
self.addEventListener('fetch',e=>{
  ...
  // Navigation is NETWORK FIRST so a new GitHub Pages deployment wins over old cache.
  ...
  // Static local assets can be cache-first. Google OAuth/Picker/Drive are different origins and never reach here.
